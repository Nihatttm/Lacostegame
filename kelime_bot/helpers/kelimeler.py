import random
kelimeler =["gözlər", "məlumat", "sual", "möhkəm", "ayrılmaq", "zaman", "su", "istifadə ediləcək", "yox", "görmək",
              "dərinizdən", "ən çox", "amma", "lirə", "oynamaq", "çiçək", "şəhər", "yüksəlmək", "döyüşmək", "var olmaq", "etmək",
              ...
              "saxla", "bir-birini", "heç nə", "et", "su", "kimi", "dövlət", "sağ", "orta", "başqa", "böyük", "etmək",
              ...
              'yemək', 'heç', 'hətta', 'necə', 'hamısı', 'əleyhinə', 'tapmaq', 'belə', 'yaşamaq', 'düşünmək', 'eyni', 'içmək', 'ancaq ' ',
              ...
              'tapşırıq', 'məqsəd', 'region', 'film', 'to', 'müştəri', 'artıq', 'telefon', 'təhsil', 'dəniz', 'ikinci', 'qalx', 'hətta', 'təsir', 'inkişaf etmək', 'keçmək', 'bədən', 'düşüncə', 'milyon', 'oynamaq', 'dəyişiklik', 'əsas',
              ...
              'müəllif', 'qulaq', 'müəllim', 'səbəb', 'sol', 'yaxşı', 'yağ', 'bağlanmaq üçün', 'gəlib', 'gülmək', 'qayda' ,
              ...
              'yaşamaq', 'ağ', 'istəkli', 'arxada', 'çalışmaq', 'qardaş', 'çəkilmə', 'harada', 'oğurluq', 'icazə', 'qorxu',
              ...
              'hərtərəfli', 'dağ', 'yaxın', 'addım', 'ciddi', 'həll', 'impress', 'bələdiyyə', 'inkişaf', 'seçki', 'ağlama', 'əlaqəli', 'konsept', 'artım', 'fəaliyyət', 'zərər', 'dərin', 'lounge', 'bir növ', 'kəsilmiş',
